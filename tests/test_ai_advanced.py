...
from deep_git.ai.analyzer import score_complexity, extract_keywords, classify_change
...
def advanced_repo(tmp_path):
    ...
    subprocess.run([sys.executable, "-m", "deep_git.main", "add", "app.py", "utils.py", "tests.py"],
