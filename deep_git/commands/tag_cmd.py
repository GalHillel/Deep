"""
deep_git.commands.tag_cmd
~~~~~~~~~~~~~~~~~~~~~~~~~
``deepgit tag`` command implementation.
"""
...
from deep_git.core.objects import Tag
from deep_git.core.refs import create_tag, list_tags, resolve_head
