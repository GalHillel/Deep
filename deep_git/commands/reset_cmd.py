"""
deep_git.commands.reset_cmd
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
``deepgit reset [--hard] <commit>`` command implementation.
...
from deep_git.core.refs import get_current_branch, update_branch, update_head
