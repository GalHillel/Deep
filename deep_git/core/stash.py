...
from deep_git.core.index import write_index, read_index
from deep_git.core.merge import three_way_merge
...
from deep_git.core.status import _get_head_tree_entries, compute_status
...
def save_stash(repo_root: Path) -> Optional[str]:
    ...
    commit = Commit(
        ...
        author="Deep Git Stash <stash@deepgit>",
        committer="Deep Git Stash <stash@deepgit>",
    ...
    if head_sha:
        ...
        from deep_git.core.index import Index, IndexEntry
        new_index = Index()
...
def pop_stash(repo_root: Path) -> bool:
    ...
    from deep_git.core.index import Index, IndexEntry, read_index
